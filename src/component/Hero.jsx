...
import sebas_img from '../assets/img/sebas_img2.png'
import sebas_img2 from '../assets/img/sebas_img2.jpg'
...
const Hero = ({ lang }) => {
  ...
  return (
    <article className=" items-center flex w-full flex-col px-5 py-12 max-md:max-w-full">
      <div className="w-full max-w-[1216px] text-center my-12 max-md:max-w-full max-md:my-10 gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0 hidden md:block">
      <span className="animate__animated animate__fadeIn text-mc-text-title text-4xl self-stretch w-full font-bold md:text-8xl">
            MC Company
          </span>
      </div>
        ...
        <section className="max-md:w-full max-md:ml-0 items-center w-full">
          <div className="flex justify-center">
            ...
            <img
              ...
              src={sebas_img}
              width={500}
              className="rounded-lg drop-shadow-xl  max-md:max-w-full max-md:mt-10"
            // style={{ borderRadius: "50% 50% 0% 10% / 50% 50% 0% 0%  " }}
            />
          </div>
        </section>
        <section className="max-md:w-full max-md:ml-0 items-center w-full md:hidden text-center">
          <span className="animate__animated animate__fadeIn text-mc-text-title text-4xl self-stretch w-full font-bold md:text-1xl">
            MC Company
          </span>
        </section>
